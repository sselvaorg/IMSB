        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {stocks.map((operation) => (
              <tr key={operation.id} className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td className="px-6 py-4">{formatDate(operation.date.toString())}</td>
                <td className="px-6 py-4">{operation.article}</td>
                <td className="px-6 py-4">{operation.intervenant || "N/A"}</td>
